...
//import org.apache.zeppelin.mongodb.MongodbInterpreter;
...
//  private static MongodbInterpreter interpreter;
//
...
//    props.put(MongodbInterpreter.ELASTICSEARCH_HOST, ELS_HOST);
//    props.put(MongodbInterpreter.ELASTICSEARCH_PORT, ELS_TRANSPORT_PORT);
//    props.put(MongodbInterpreter.ELASTICSEARCH_CLUSTER_NAME, ELS_CLUSTER_NAME);
//    interpreter = new MongodbInterpreter(props);
//    interpreter.open();
//  }
//
//  @AfterClass
